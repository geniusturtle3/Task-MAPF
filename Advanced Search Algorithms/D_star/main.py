...
if __name__ == "__main__":
    ...
    # grid, start, goal = load_map('D_star/map2.csv')
    # dynamic_grid, _, _ = load_map('D_star/dynamic_map2.csv')
    # grid, start, goal = load_map('D_star/map3.csv')
    # dynamic_grid, _, _ = load_map('D_star/dynamic_map3.csv')
